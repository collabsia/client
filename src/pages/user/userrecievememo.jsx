  ...
  useEffect(() => {
    const fetchMemoDetails = async () => {
      try {
        ...
        const res = await axios.get(`/api/memo/pdfdetails/${memoId}`, {
          params: {
            token,
          },
          headers: {
        ...
        const googleCalendarResponse = await axios.get('/api/isgooglecalendarsave', {
          params: {
            token,
            memoId
          },
      ...
      try {
        if (memoDetails) { // Check if memoDetails is defined
          ...
          if (tokenResponse && tokenResponse.access_token) {
            ...
            await axios.post('/api/googlecalendersave', {
              token,
              memoId
            }, {
              headers: {
